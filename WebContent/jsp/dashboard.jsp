   ...
   <div id="content">
		...
		<s:iterator value="list" >
			<tr  align="left"  style="outline-color: black;">
				...
				<td align="center"><a href="#" onclick="doEdit(<s:property value="userDetailID" />)">Edit</a></td>
				<td align="center"><a href="#" onclick="doDelete(<s:property value="userDetailID" />)">Delete</a></td>
			</tr>
