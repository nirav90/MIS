...
<div id="Fire Insurance" class="t">
	...
	<table width="100%">
		...
		<tr><td><b> Building Including plinth & Foundation </b></td>
             ...
             <td rowspan="5"> <s:textfield name="discount" id="discount" theme="simple"/></td>
             <td rowspan="5"> <s:textfield name="premiumBeforeTerroAndTax" id="premiumBeforeTerroAndTax" theme="simple" onblur="javascript:getTotalpremiumBeforeTerroAndTax(0);"/></td>
             <td rowspan="5"> <s:textfield name="terrorismPremium" id="terrorismPremium" theme="simple" onchange="javascript:getTotalPremiumNetOfServiceTax2(0);" onblur="javascript:getTotalterrorismPremium(0);"/></td>
             <td rowspan="5"> <s:textfield name="premiumNetOfServiceTax" id="premiumNetOfServiceTax" theme="simple" onblur="javascript:getTotalpremiumNetOfServiceTax(0);javascript:getTotalserviceTax(0);javascript:getTotalPremiumPaid(0);"/></td>
             <td rowspan="5"> <s:textfield name="serviceTax" id="serviceTax" theme="simple"/></td>
             <td rowspan="5"> <s:textfield name="totalPremiumPaid" id="totalPremiumPaid" theme="simple"/></td>
       </tr>
