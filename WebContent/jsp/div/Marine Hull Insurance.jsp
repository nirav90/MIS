	...
	<table width="100%">
		...
		<tr>
         ...
         <tr><td><b>Sum Insured </b></td>                    
             ...
             <td> <s:textfield name="policyRate" id="policyRate" theme="simple" onchange="javascript:getTotalPremiumNetOfServiceTax3(0);"/></td>
             ...
             <td> <s:textfield name="totalPremiumPaid" id="totalPremiumPaid" theme="simple" onblur="javascript:getTotalPremiumPaid(0);"/>
         </tr>
