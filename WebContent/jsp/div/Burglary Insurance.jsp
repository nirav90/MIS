...
<table border='0' align="center" style="width: 100%; background-color: white;" cellpadding="4" cellspacing="2">
	...
	<tr>
		<td><s:textfield name="policyDetailForm.riskLocation" value="Unit 2" theme="simple" /></td>
		<td colspan="3"><s:textfield name="policyDetailForm.riskAddress" value="%{policyDetailForm.riskAddress}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.city" value="%{policyDetailForm.city}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.state" value="%{policyDetailForm.state}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.country" value="%{policyDetailForm.country}" theme="simple" /></td>
	...
	<tr>
		<td><s:textfield name="policyDetailForm.riskLocation" value="Unit 3" theme="simple" /></td>
		<td colspan="3"><s:textfield name="policyDetailForm.riskAddress" value="%{policyDetailForm.riskAddress}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.city" value="%{policyDetailForm.city}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.state" value="%{policyDetailForm.state}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.country" value="%{policyDetailForm.country}" theme="simple" /></td>
	...
	<tr>
		<td><s:textfield name="policyDetailForm.riskLocation" value="Unit 4" theme="simple" /></td>
		<td colspan="3"><s:textfield name="policyDetailForm.riskAddress" value="%{policyDetailForm.riskAddress}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.city" value="%{policyDetailForm.city}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.state" value="%{policyDetailForm.state}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.country" value="%{policyDetailForm.country}" theme="simple" /></td>
	...
	<tr>
		<td><s:textfield name="policyDetailForm.riskLocation" value="Unit 5" theme="simple" /></td>
		<td colspan="3"><s:textfield name="policyDetailForm.riskAddress" value="%{policyDetailForm.riskAddress}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.city" value="%{policyDetailForm.city}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.state" value="%{policyDetailForm.state}" theme="simple" /></td>
		<td><s:textfield name="policyDetailForm.country" value="%{policyDetailForm.country}" theme="simple" /></td>
...
<div id="Burglary Insurance" class="t">
	...
	<table width="100%">
		...
		<tr>
			...
			<td><s:textfield name="policyRate" id="policyRate" theme="simple" onblur="javascript:getTotalPremiumNetOfServiceTax4(0);"/></td>
			<td><s:textfield name="premiumNetOfServiceTax" id="premiumNetOfServiceTax" theme="simple" onblur="javascript:getTotalpremiumNetOfServiceTax(0);"/></td>
			<td><s:textfield name="serviceTax" id="serviceTax" theme="simple" onblur="javascript:getTotalserviceTax(0);"/></td>
			<td><s:textfield name="stampDuty" id="stampDuty" theme="simple" onchange="javascript:getTotalStampDuty(0);" onblur="javascript:getTotalstampDuty(0);" /></td>
			<td><s:textfield name="totalPremiumPaid" id="totalPremiumPaid" theme="simple" onblur="javascript:getTotalPremiumPaid(0);"/></td>	
		</tr>
		...
		<tr>
			...
			<td><s:textfield name="policyRate" id="policyRate"  theme="simple" onblur="javascript:getTotalPremiumNetOfServiceTax4(1);"/></td>
			<td><s:textfield name="premiumNetOfServiceTax" id="premiumNetOfServiceTax" theme="simple" onblur="javascript:getTotalpremiumNetOfServiceTax(1);" /></td>
			<td><s:textfield name="serviceTax" id="serviceTax" theme="simple" onblur="javascript:getTotalserviceTax(1);"/></td>
			<td><s:textfield name="stampDuty" id="stampDuty"  theme="simple" onchange="javascript:getTotalStampDuty(1);" onblur="javascript:getTotalstampDuty(1);"/></td>
			<td><s:textfield name="totalPremiumPaid" id="totalPremiumPaid" theme="simple" maxlength="6" onblur="javascript:getTotalPremiumPaid(1);"/></td>	
		</tr>
	
		<tr>
			<td><b>Theft Extension(if any)</b></td>
			<td><s:textfield name="sumInsINR" id="sumInsINR" theme="simple" onblur="javascript:getTotalsumInsINR(2);"/></td>
			<td><s:textfield name="policyRate" id="policyRate"  theme="simple" onblur="javascript:getTotalPremiumNetOfServiceTax4(2);"/></td>
			<td><s:textfield name="premiumNetOfServiceTax" id="premiumNetOfServiceTax" theme="simple" onblur="javascript:getTotalpremiumNetOfServiceTax(2);" /></td>
			<td><s:textfield name="serviceTax" id="serviceTax" theme="simple" onblur="javascript:getTotalserviceTax(2);"/></td>
			<td><s:textfield name="stampDuty" id="stampDuty"  theme="simple" onchange="javascript:getTotalStampDuty(2);" onblur="javascript:getTotalstampDuty(2);"/></td>
			<td><s:textfield name="totalPremiumPaid" id="totalPremiumPaid" theme="simple" maxlength="6" onblur="javascript:getTotalPremiumPaid(2);"/></td>		
		</tr>
