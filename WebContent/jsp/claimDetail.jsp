				...
				<s:form action="addClaimDetail" name="ClaimForm" method="POST">
					<s:div>
						<table border='0' align="center"
							...
							<tr>
								<td>Claim Id</td>
								<td><s:label name="claimId" value="%{claimId}"
										theme="simple" /></td>
								<td>Date of Intimation</td>
								<td><s:label name="DateOfIntimation"
										value="%{DateOfIntimation}" readonly="true" theme="simple"
										cssClass="tcal" size="23" /></td>
							</tr>
							<tr>
								<td>Claimant Name</td>
								<td><s:label name="claimantName"
										value="%{claimantName}" theme="simple" /></td>
								<td>Name Of Portfolio Director</td>
								<td><s:label name="nameOfPortfolioDirector"
										list="#{'1':'--Select--'}" theme="simple"></s:label></td>
							</tr>
							<tr>
								<td>Address For Communication</td>
								<td><s:label name="claimAddress"
										value="%{claimAddress}" theme="simple" /></td>
								<td>Name Of Investigator</td>
								<td><s:label name="namerOfInvestigator"
										list="#{'Nirav':'nirav'}" theme="simple"></s:label></td>
							</tr>
							<tr>
								<td></td>
								<td><s:label name="address2" value="%{address2}"
										theme="simple" /></td>
								<td>Date Of Appointment Of Investigator</td>
								<td><s:label name="dateOfAppointmentOfInvestigator"
							...
							<tr>
								<td>Area</td>
								<td><s:label name="area" value="%{area}" theme="simple" /></td>
								<td>Data Entered by</td>
								<td><s:label name="dataEnteredBy"
										value="%{dataEnteredBy}" theme="simple" /></td>
							</tr>
							<tr>
								<td>Taluka</td>
								<td><s:label name="taluka" value="%{taluka}"
										theme="simple" /></td>
								<td>Scheme Name</td>
								<td><s:label name="scheme"
										list="#{'ahmedabad':'ahmedabad'}" theme="simple"></s:label></td>
							</tr>
							<tr>
								<td>District</td>
								<td><s:label name="district" value="%{district}"
										theme="simple" /></td>
								<td>Type Of Claim</td>
								<td><s:label name="typeOfClaim"
										list="#{'ahmedabad':'ahmedabad'}" theme="simple"></s:label></td>
							</tr>
							<tr>
								<td>Pin Code</td>
								<td><s:label name="pincode" value="%{pincode}"
										theme="simple" /></td>
								<td>Claim Intimation Amount</td>
								<td><s:label name="claimIntimationAmount"
										value="%{claimIntimationAmount}" theme="simple" /></td>
							</tr>
							<tr>
								<td>Landline No</td>
								<td><s:label name="landLineNo" value="%{landLineNo}"
										theme="simple" /></td>
							...
							<tr>
								<td>Mobile No 1</td>
								<td><s:label name="mobileNo1" value="%{mobileNo1}"
										theme="simple" /></td>
								<td>Status</td>
								<td><s:label id="Status" name="Status"
										list="#{'1':'--Select--','2':'Query Raised','3':'Paid','4':'No Claim','5':'Underprocess'}"
										theme="simple"></s:label></td>
							</tr>
							<tr>
								<td>Mobile No 2</td>
								<td><s:label name="mobileNo2" value="%{mobileNo2}"
										theme="simple" /></td>
								<td></td>
							...
							<div id="queryRaised" style="display: none;">
								<tr>
									<td>Type Of Query</td>
									<td><s:label name="typeOfQuery" list="#{'LIFE':'LIFE'}"
											theme="simple"></s:label></td>
									<td>Time Left To Submit the Query</td>
									<td><s:label name="timeLeftToSubmit"
								...
								<tr>
									...
									<td><s:label name="dateOfQuerySend"
											value="%{dateOfQuerySend}" readonly="true" theme="simple"
											cssClass="tcal" size="23" /></td>
								</tr>
								<tr>
									<s:label label="POD Details" name="podDetail" cols="40"
										rows="10" />
								</tr>
							</div>
