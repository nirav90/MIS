...
<script type="text/javascript">
	...
	function doBusinessStatusView(data) {
		document.getElementById("h1").value = data;
		//alert(document.getElementById("h1").value);
		document.getElementById("form").action = "viewBusinessStatus?policyName="
				+ document.getElementById("policyName").value;
		// 		alert(document.getElementById("form").action);
		document.getElementById("form").submit();
	}
	...
	function reportByPolicyStartDate() {
		...
		var s1 = document.getElementById("policyEndDate").value.trim();
		var queryString = "startDate=" + s + "&endDate=" + s1 + "";
		document.getElementById("form1").action = "generateReportByPolicyStartDate?"
				+ queryString;
	...
	function reportByPolicyEndDate() {
		...
		var s1 = document.getElementById("PolicyEndEndDate").value.trim();
		var queryString = "startDate=" + s + "&endDate=" + s1 + "";
		document.getElementById("form1").action = "generateReportByPolicyEndDate?"
				+ queryString;
		// 		alert(document.getElementById("form2").action);
		document.getElementById("form1").submit();
	}
					...
					<table style="width: 100%">
						<tr>
							<s:form id="form1">
								...
								<td><s:submit onclick="reportByDateOfInward()"
										theme="simple" value="GO" /></td>
								<%-- 							</s:	form> --%>
 ...
 --%>
				...
				<div id="Relation Manager" class="t1">
					<table>
						<tr>
							...
							<td><s:submit value="GO" onclick="reportByRelationManager()"
									theme="simple" /></td>
						</tr>
					</table>
				</div>
				<div id="Insured Name" class="t1">
					...
					<table>
						<tr>
							...
							<td><s:submit value="GO" onclick="reportByInsuredName()"
									theme="simple" /></td>
						</tr>
					</table>
				</div>
					...
					<table>
						<tr>
							...
							<td><s:submit value="GO"
									onclick="reportByInsuranceCompany()" theme="simple" /></td>
						</tr>
					</table>
				</div>
					...
					<table>
						<tr>
							...
							<td><s:textfield id="policyStartDate" theme="simple"
									name="startDate" cssClass="tcal">
								</s:textfield></td>
							<td>To:</td>
							<td><s:textfield id="policyEndDate" theme="simple"
									cssClass="tcal" name="endDate">
								</s:textfield></td>
							<td><s:submit value="GO" onclick="reportByPolicyStartDate()"
									theme="simple" /></td>
						</tr>
						<%-- <tr>
							<td><s:submit value="Go"
					...
					<table>
						<tr>
							...
							<td><s:textfield id="PolicyEndStartDate" theme="simple"
									cssClass="tcal" name="startDate">
								</s:textfield></td>
							<td>To:</td>
							<td><s:textfield id="PolicyEndEndDate" theme="simple"
									cssClass="tcal" name="endDate">
								</s:textfield></td>
							<td><s:submit value="GO" onclick="reportByPolicyEndDate()"
									theme="simple" /></td>
						</tr>
					</table>
				</div>
				<div id="custom Search" class="t1">
					<table>
						...
						<tr>
							<td></td>
							<td><s:submit value="GO" onclick="reportByCustomSearch()"
									theme="simple" /></td>
