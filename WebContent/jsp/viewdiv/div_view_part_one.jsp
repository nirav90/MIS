...
<div id="Motor Act Only" class="t1">
...
<div id="Credit Insurance" class="t1">
	...
	<table width="100%">
		...
		<tr><td><b><s:label> Anual Turnover Limit </s:label></b></td>
                        <td> <s:label name="sumInsINR" theme="simple"/></td>
                        <td> <s:label name="discount" theme="simple"/></td>
                        <td> <s:label name="premiumBeforeTerroAndTax" theme="simple"/></td>
                        <td> <s:label name="terrorismPremium" theme="simple"/></td>
                        <td> <s:label name="premiumNetOfServiceTax" theme="simple"/></td>
                        <td> <s:label name="serviceTax" theme="simple"/></td>
                        <td> <s:label name="totalPremiumPaid" theme="simple"/></td>
                        </tr>
...
<div id="Burglary Insurance" class="t1">
	...
	<table width="100%">
		...
		<tr>
			...
			<td><s:label name="sumInsINR" id="sumInsINR" theme="simple"/></td>
			<td><s:label name="policyRate" id="policyRate" theme="simple"/></td>
			<td><s:label name="premiumNetOfServiceTax" id="premiumNetOfServiceTax" theme="simple"/></td>
			<td><s:label name="serviceTax" id="serviceTax" theme="simple"/></td>
			<td><s:label name="stampDuty" id="stampDuty" theme="simple"/></td>
			<td><s:label name="totalPremiumPaid" id="totalPremiumPaid" theme="simple"/></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td><b><s:label name="line_1" theme="simple"/></b></td>
			<td><s:label name="sumInsINR" id="sumInsINR"  theme="simple"/></td>
			<td><s:label name="policyRate" id="policyRate"  theme="simple"/></td>
			<td><s:label name="premiumNetOfServiceTax" theme="simple"/></td>
			<td><s:label name="serviceTax" theme="simple"/></td>
			<td><s:label name="stampDuty"  theme="simple"/></td>
			<td><s:label name="totalPremiumPaid" theme="simple"/></td>
			<td></td>
		</tr>
	
		<tr>
			<td><b><s:label name="line_2" theme="simple"/></b></td>
			<td><s:label name="sumInsINR" id="sumInsINR"  theme="simple"/></td>
			<td><s:label name="policyRate" id="policyRate"  theme="simple"/></td>
			<td><s:label name="premiumNetOfServiceTax" theme="simple"/></td>
			<td><s:label name="serviceTax" theme="simple"/></td>
...
<div id="directors And Officers Liabilty" class="t1">
...
<div id="Event & Media Liabilty" class="t1">
...
<div id="Export Credit Guarantee" class="t1">
...
<div id="Fire Long Term" class="t1">
...
<div id="Fire Insurance" class="t1">
...
<div id="Group Mediclaim" class="t1">
		...
		<tr>
			...
			<td colspan="7"><center><b>Details</b></center></td>
                    ...
                    <tr><td><b>No Of Employee Covered </b></td>
                        <td> <s:label name="no" theme="simple"/></td>
                        <td> <s:label name="sumInsINR" theme="simple"/></td>
                        <td> <s:label name="premiumNetOfServiceTax" theme="simple"/></td>
                        <td> <s:label name="serviceTax" theme="simple"/></td>
                        <td> <s:label name="totalPremiumPaid" theme="simple"/></td><td></td><td></td>
                        </tr>
...
<div id="Group Personal Acciedent" class="t1">
...
<div id="Individual Mediclaim" class="t1">
...
<div id="Individual Personal Acciedent" class="t1">
...
<div id="Industrial Act Liability" class="t1">
...
<div id="Industrial All Risk" class="t1">
		...
		<tr>
		 ...
		 <tr>
                    ...
                    <tr><td><b>Building including Plinth and Fundation</b></td>
                        ...
                        <td> <s:label name="serviceTax" id="serviceTax" theme="simple"/></td>
                        <td> <s:label name="stampDuty" id="stampDuty"  theme="simple"/></td>
                        <td> <s:label name="totalPremiumPaid" id="totalPremiumPaid" theme="simple"/></td><td></td>
                        </tr>
                    <tr><td><b>Plant and Machinery</b></td>                    
                        <td> <s:label name="sumInsINR" id="sumInsINR"  theme="simple"/></td>
                        <td> <s:label name="policyRate" id="policyRate"  theme="simple"/></td>
